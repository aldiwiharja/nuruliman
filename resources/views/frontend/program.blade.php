                ...
                <div class="card register-now">
                    ...
                    <div class="card-body">
                        <div class="row justify-content-center">
                            <div class="col-md-5">
                                <div class="card" style="height: 20rem; background-color: rgba(255, 255, 255, 0.7)">
                                    <div class="card-body">
                                        <h5>{{ \Str::upper($query) }}</h5>
                                ...
                                <div class="card" style="height: 20rem; background-color: rgba(255, 255, 255, 0.7)">
                                    ...
                                    <div class="card-body">
                                        <div class="text-center">
                                            ...
                                            <h2>2021-2022</h2>
                                            <button class="btn btn-block btn-success mt-4">FORMULIR PENDAFTARAN</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
